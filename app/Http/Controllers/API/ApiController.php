...
class ApiController extends BaseController
{
    ...
    public function getVerifiedMachineStatus(Request $request){
        ...
        $active = DB::table("machines AS m")->join('depots AS d', 'd.id', '=', 'm.depot_id')->select("d.name AS `Depot Name`", "COUNT(m.*) AS `numbers`")->where(function ($query) {
        ...
        $inactive = DB::table("machines AS m")->join('depots AS d', 'd.id', '=', 'm.depot_id')->select("d.name` AS `Depot Name`", "COUNT(m.*) AS `numbers`")->where(function ($query) {
            $query->whereNotNull('m.client_id');
